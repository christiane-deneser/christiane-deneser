...
*(Repos may be renamed / reorganized as my a11y-lab evolves.)*

- **`a11y-lab`**  
  Sandbox for accessible UI components, patterns, and experiments.  
  Each component aims to include:
  - Clear purpose & usage  
  - Keyboard and screen reader behavior  
  - WCAG / EN 301 549 mapping  
  - Code examples (HTML/CSS/JS)  
  - Notes on common pitfalls & anti-patterns  

- **Accessible Component Library (work in progress)**  
  A structured set of components such as:
  - Buttons & link patterns
  - Dialogs & modals
  - Navigation & menus
  - Tabs, accordions, sliders
  - Visually hidden utility and skip links

- **WCAG Learning Notes**  
  My personal notes on:
  - Guidelines, success criteria in plain language
  - Typical issues found in audits
  - Testing strategies and triage approaches

---

## 💖 Work culture & what I value (reflection from Ableton)

During my time at **Ableton**, I worked with some of the most skilled, generous, and deeply professional people I’ve ever met.  
But the real gift was the **culture**:
...
- Deepening my understanding of **WCAG 2.2** success criteria  
- Building **EN 301 549** awareness into day-to-day design & dev decisions  
...
- **Website:** [Personal Website christianedeneser.com](https://christianedeneser.com)  
